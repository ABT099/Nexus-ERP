...
ALTER TABLE payment
    ADD CONSTRAINT FK_PAYMENT_ON_CREATEDBY FOREIGN KEY (created_by_id) REFERENCES _user (id);

ALTER TABLE payment
    ADD CONSTRAINT FK_PAYMENT_ON_LASTMODIFIEDBY FOREIGN KEY (last_modified_by_id) REFERENCES _user (id);

ALTER TABLE payment
    ADD CONSTRAINT FK_PAYMENT_ON_PAYER FOREIGN KEY (payer_id) REFERENCES _user (id);

ALTER TABLE payment
    ADD CONSTRAINT FK_PAYMENT_ON_PROJECT FOREIGN KEY (project_id) REFERENCES project (id);
